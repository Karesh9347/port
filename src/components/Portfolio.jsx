...
const projectList = [
  ...
  },
  {
    ...
    description:
      "Created an AI-powered interview system using machine learning algorithms to evaluate candidates' responses in real-time, providing detailed analysis and feedback. Integrated this in TechDosth to conduct mock interviews for students.",
    url: "https://github.com/yourusername/ai-interview-system", 
  },
  {
